...
import { ArrowDownTrayIcon, ChartBarIcon, HomeIcon, PaperAirplaneIcon, PhotoIcon } from "@heroicons/react/24/outline";
            ...
            {!isConnected && isLoadingBurnerWallet ? (
              ...
              <>
                ...
                <div className="flex gap-6 justify-center mb-8">
                  ...
                  <button
                    className={`${screen === "polls" ? "bg-primary" : "bg-secondary"} text-white rounded-full p-3`}
